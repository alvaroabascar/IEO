...
Regretfully glioblastomas are notorious for resistance to therapy (and, consequently, also recurrence), which has been attributed to DNA-repair proficiency, a multitude of deregulated molecular pathways, and, more recently, to the particular
Regretfully glioblastomas are notorious for resistance to therapy (and, consequently, also recurrence), which has been attributed to DNA-repair proficiency, 
Regretfully glioblastomas are notorious for resistance to therapy (and, consequently
\end{abstract}
...
\subsubsection*{Simple GSEA}: %PONER COMO SE HIZO
