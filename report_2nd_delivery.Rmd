...
genesGS2 <- colnames(Im)[which(Im["REACTOME_TRANSLATION", ] == 1)]
genesGS3 <- colnames(Im)[which(Im["REACTOME_STABILIZATION_OF_P53", ] == 1)]
genesGS4 <- colnames(Im)[which(Im["REACTOME_APOPTOSIS", ] == 1)]
genesGS5 <- colnames(Im)[which(Im["REACTOME_M_G1_TRANSITION", ] == 1)]
...
plotGS(eset_GSEA, genesGS2, "disease_status", main = "REACTOME_TRANSLATION", cex.lab = 2, las = 1)
plotGS(eset_GSEA, genesGS3, "disease_status", main = "REACTOME_STABILIZATION_OF_P53", cex.lab = 2, las = 1)
plotGS(eset_GSEA, genesGS4, "disease_status", main = "REACTOME_APOPTOSIS", cex.lab = 2, las = 1)
plotGS(eset_GSEA, genesGS5, "disease_status", main = "REACTOME_M_G1_TRANSITION", cex.lab = 2, las = 1)
