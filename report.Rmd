...
The analysis by Murat, A. et al. includes a process of gene clustering using CTWC ([see their gene clusters here](http://bcf.isb-sib.ch/projects/cancer/glio/Results-56231395/index.html)), leading to a reduced set that is key to obtain statistically significant results. In our case we have tested each gene separately, an approach with a much lower statistical power.
