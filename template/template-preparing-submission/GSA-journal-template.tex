...
The analysis of diferential expression resulted in 101 genes differentially expressed (corrected p-value < 0.05) across the two conditions (recurrent and non-recurrent GBM). The GO enrichment analysis revealed 14 GO terms
